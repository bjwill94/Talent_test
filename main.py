...
if uploaded_file1 and uploaded_file2:
    ...
    # # Convert 'chest no' to string type (immediately after reading the file)
    # df_marks['chest no'] = df_marks['chest no'].astype(str)
    # df_names['chest number'] = df_names['chest number'].astype(str)  # Also convert in the second DataFrame
